...
const ROUTES = {
  ...
  "/api/service-packages": "servicePackages",
...
// Módulo Playbooks Comerciales — Comercialización
// (registrado antes del listen para que las rutas queden montadas)
registerPlaybooks(app, { pool, readCol, writeCol, wrap });
